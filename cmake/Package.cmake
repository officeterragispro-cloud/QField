...
set(CPACK_PACKAGE_EXECUTABLES qfield;${APP_NAME})
set(CPACK_PACKAGE_HOMEPAGE_URL "https://terragispro.ro")
set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_SOURCE_DIR}/LICENSE")
set(CPACK_PACKAGE_VENDOR "TerraGIS Pro")
...
if(WIN32)
    ...
    set(CPACK_WIX_UPGRADE_GUID A5BF5B7D-9C80-4E0F-83AB-5AB9E1DDC92B)
    set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_SOURCE_DIR}/LICENSE.txt")
    if(APP_ICON_PATH AND EXISTS "${APP_ICON_PATH}/windows/${APP_ICON}.ico")
        set(CPACK_WIX_PRODUCT_ICON "${APP_ICON_PATH}/windows/${APP_ICON}.ico")
        set(CPACK_WIX_PRODUCT_LOGO "${APP_ICON_PATH}/windows/${APP_ICON}.png")
    else()
        set(CPACK_WIX_PRODUCT_ICON "${CMAKE_SOURCE_DIR}/images/icons/qfield_logo.ico")
        set(CPACK_WIX_PRODUCT_LOGO "${CMAKE_SOURCE_DIR}/images/icons/qfield_logo.png")
    endif()
    set(CPACK_WIX_PATCH_FILE "${CMAKE_SOURCE_DIR}/platform/windows/wix_patch.xml")
    set(CPACK_GENERATOR "WIX")
    if (VCPKG_TARGET_TRIPLET STREQUAL "arm64-windows-static")
...
if(ANDROID AND ANDROIDDEPLOYQT_EXECUTABLE)
    ...
    file(MAKE_DIRECTORY "${ANDROID_TEMPLATE_FOLDER}/src/${APP_PACKAGE_PATH}")
    file(GLOB ORIGINAL_JAVA_FILES "${ANDROID_TEMPLATE_FOLDER}/src/ch/opengis/qfield/*.java")
    file(COPY ${ORIGINAL_JAVA_FILES} DESTINATION ${SRC_FOLDER})
    if(NOT APP_PACKAGE_ID STREQUAL "ch.opengis.qfield")
      file(REMOVE_RECURSE "${ANDROID_TEMPLATE_FOLDER}/src/ch/opengis/qfield")
    endif()
    file(GLOB JAVA_FILES "${SRC_FOLDER}/*.java")
    foreach(JAVA_FILE ${JAVA_FILES})
      message(STATUS ${JAVA_FILE})
      file(READ ${JAVA_FILE} CONTENT)
      string(REGEX REPLACE "ch.opengis.qfield" "${APP_PACKAGE_ID}"
                           CONTENT "${CONTENT}")
