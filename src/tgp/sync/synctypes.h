...
namespace Tgp
{
  ...
  inline ExportState exportStateFromName( const QString &name )
  {
    ...
    if ( name == QLatin1String( "waiting_for_network" ) )
      return ExportState::WaitingForNetwork;
    if ( name == QLatin1String( "uploading" ) )
      return ExportState::Uploading;
    if ( name == QLatin1String( "verifying" ) )
      return ExportState::Verifying;
    if ( name == QLatin1String( "complete" ) )
